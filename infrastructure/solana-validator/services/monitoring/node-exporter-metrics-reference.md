...
|--------|-------------------|-------------------|-------|
| CPU Usage | >80% | >90% | Sustained high CPU can affect vote timing |
| Memory Usage | >80% | >90% | Memory pressure can lead to swapping |
| Swap Activity | >0 | >10 pages/sec | Any swap activity is concerning |
| Disk Utilization | >70% | >90% | High utilization affects I/O response time |
| I/O Wait | >5% | >10% | Indicates disk bottlenecks |
| File Descriptors | >100,000 | >150,000 | High number may indicate resource leaks |
| Disk Space | >70% | >90% | Running out of space causes validator failure |
| CPU Temperature | >80°C | >90°C | High temperatures may cause throttling |
| Disk Temperature | >50°C | >70°C | NVMe drives throttle at high temperatures |
| Disk Write Latency | >5ms | >10ms | Affects transaction processing speed |
| Network Error Rate | >0.01% | >0.1% | Any persistent errors are concerning | 